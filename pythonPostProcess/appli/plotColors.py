"""
Manage colors map for the graph
"""
colors = [
    [68, 1, 84],
    [68, 2, 86],
...
def get_color(value, min_v=0, max_v=4000):
    ...
    normalized_value = (value - min_v) / (max_v - min_v)

    # Map the normalized value to the range 0 to 255 (inclusive)
    color_index = int(normalized_value * 255)
